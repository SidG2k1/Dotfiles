...
4. `git commit -m "<message>"` — write a thoughtful commit message explaining the *why*. The subject is the PR title if this is a new branch; lead with a clear, scannable line.
