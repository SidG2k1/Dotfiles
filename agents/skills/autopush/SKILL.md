...
4. `git commit -S -m "<message>"` — write a thoughtful commit message explaining the *why*. The subject is the PR title if this is a new branch; lead with a clear, scannable line. (Signing flows through 1Password SSH per ~/.gitconfig.)
